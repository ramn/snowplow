CREATE TABLE IF NOT EXISTS events (
	...
	`ev_value` float,
	`br_name` varchar(20) comment 'lookup',
	`br_family` varchar(20) comment 'lookup',
	`br_version` varchar(20) comment 'lookup',
	`br_type` varchar(20) comment 'lookup',
	`br_renderengine` varchar(20) comment 'lookup',
	`br_lang` varchar(20) comment 'lookup',
	...
	`br_cookies` boolean,
	`os_name` varchar(20) comment 'lookup',
	`os_family` varchar(20) comment 'lookup',
	`os_manufacturer` varchar(20) comment 'lookup',
	`dvce_type` varchar(20) comment 'lookup',
